...
AIOT_DEVICE_MAPPING = [
    ...
    ###########################方舟智慧中枢M3网关#############################
    {
        ...
        "params": [
            ...
            },
            {
                "binary_sensor": {
                    MK_INIT_PARAMS: {
                        MK_HASS_NAME: "connectivity",
                        "device_class": BinarySensorDeviceClass.CONNECTIVITY,
                    },
                    MK_RESOURCES: {"online": ("8.0.2045", "_attr_is_on")},
                }
            },
            {
                "number": {
                    MK_INIT_PARAMS: {
                        MK_HASS_NAME: "system_volume",
                        "min_value": 0,
                        "max_value": 100,
                        "step": 1,
                    },
                    MK_RESOURCES: {"volume": ("14.11.85", "_attr_native_value")},
                }
            },
            {
                "number": {
                    MK_INIT_PARAMS: {
                        MK_HASS_NAME: "alarm_volume",
                        "min_value": 0,
                        "max_value": 100,
                        "step": 1,
                    },
                    MK_RESOURCES: {"alarm_volume": ("14.1.1000", "_attr_native_value")},
                }
            },
            {
                "number": {
                    MK_INIT_PARAMS: {
                        MK_HASS_NAME: "music_volume",
                        "min_value": 0,
                        "max_value": 100,
                        "step": 1,
                    },
                    MK_RESOURCES: {"volume": ("14.3.1000", "_attr_native_value")},
                }
            },
            {
                "number": {
                    MK_INIT_PARAMS: {
                        MK_HASS_NAME: "doorbell_duration",
                        "min_value": -1,
                        "max_value": 255,
                        "step": 1,
                    },
                    MK_RESOURCES: {"duration": ("14.2.113", "_attr_native_value")},
                }
            },
            {
                "number": {
                    MK_INIT_PARAMS: {
                        MK_HASS_NAME: "alarm_duration",
                        "min_value": -1,
                        "max_value": 255,
                        "step": 1,
                    },
                    MK_RESOURCES: {"duration": ("14.1.113", "_attr_native_value")},
                }
            },
            {
                "switch": {
                    MK_INIT_PARAMS: {
                        MK_HASS_NAME: "deletion_protection",
                    },
                    MK_RESOURCES: {
                        "toggle": ("8.0.2158", "_attr_is_on"),
                    },
                }
            },
            {
                "switch": {
                    MK_INIT_PARAMS: {
                        MK_HASS_NAME: "arming_status",
                    },
                    MK_RESOURCES: {
                        "toggle": ("14.6.111", "_attr_is_on"),
                    },
                }
            },
            {
                "binary_sensor": {
                    MK_INIT_PARAMS: {
                        MK_HASS_NAME: "sleep_status",
                    },
                    MK_RESOURCES: {
                        "status": ("3.2.85", "_attr_is_on"),
                    },
                }
            },
            {
                "binary_sensor": {
                    MK_INIT_PARAMS: {
                        MK_HASS_NAME: "ac_status",
                    },
                    MK_RESOURCES: {
                        "status": ("3.1.85", "_attr_is_on"),
                    },
                }
            },
            {
                "binary_sensor": {
                    MK_INIT_PARAMS: {
                        MK_HASS_NAME: "hub_connection",
                        "device_class": BinarySensorDeviceClass.CONNECTIVITY,
                    },
                    MK_RESOURCES: {
                        "status": ("8.0.2337", "_attr_is_on"),
                    },
                }
            },
            {
                "select": {
                    MK_INIT_PARAMS: {
                        MK_HASS_NAME: "alarm_ringtone",
                        "options": ["police1", "police2", "accident", "missile", "ghost", "sniper", "battle", "air_raid", "dog"],
                    },
                    MK_RESOURCES: {
                        "value": ("14.1.85", "_attr_current_option"),
                    },
                }
            },
            {
                "select": {
                    MK_INIT_PARAMS: {
                        MK_HASS_NAME: "gateway_language",
                        "options": ["chinese", "english"],
                    },
                    MK_RESOURCES: {
                        "value": ("14.10.85", "_attr_current_option"),
                    },
                }
            },
            {
                "select": {
                    MK_INIT_PARAMS: {
                        MK_HASS_NAME: "ac_mode",
                        "options": ["not_configured", "ac_with_socket", "ac_without_socket", "ir_heater", "16a_socket"],
                    },
                    MK_RESOURCES: {
                        "value": ("14.25.85", "_attr_current_option"),
                    },
                }
            },
            {
                "sensor": {
                    MK_INIT_PARAMS: {
                        MK_HASS_NAME: "ac_type",
                    },
                    MK_RESOURCES: {"type": ("13.2.85", "_attr_native_value")},
                }
            },
            {
                "sensor": {
                    MK_INIT_PARAMS: {
                        MK_HASS_NAME: "zigbee_channel",
                        "entity_category": "diagnostic",
                    },
                    MK_RESOURCES: {"channel": ("8.0.2024", "_attr_native_value")},
                }
            },
            {
                "sensor": {
                    MK_INIT_PARAMS: {
                        MK_HASS_NAME: "hub_capability",
                        "entity_category": "diagnostic",
                    },
                    MK_RESOURCES: {"capability": ("8.0.2334", "_attr_native_value")},
                }
            },
            {
                "button": {
                    MK_INIT_PARAMS: {
                        MK_HASS_NAME: "restart_gateway",
                    },
                    MK_RESOURCES: {
                        "press": ("8.0.2108", "_attr_pressed"),
                    },
                }
            },
        ],
    ...
    {
        # 智能门铃摄像机 D100
        "lumi.camera.acn005": ["Aqara", "Smart Doorbell Camera D100", ""],
        "params": [
            {
                "switch": {
                    MK_INIT_PARAMS: {
                        MK_HASS_NAME: "low_temp_alarm",
                    },
                    MK_RESOURCES: {
                        "toggle": ("4.68.85", "_attr_is_on"),
                    },
                }
            },
            {
            ...
            },
            {
                "switch": {
                    MK_INIT_PARAMS: {
                        MK_HASS_NAME: "anti_tamper_alarm",
                    },
                    MK_RESOURCES: {
            ...
            },
            {
                "switch": {
                    MK_INIT_PARAMS: {
                        MK_HASS_NAME: "scheduled_sleep",
                    },
                    MK_RESOURCES: {
                        "toggle": ("14.125.85", "_attr_is_on"),
                    },
                }
            },
            {
                "switch": {
                    MK_INIT_PARAMS: {
                        MK_HASS_NAME: "doorbell_recording",
                    },
                    MK_RESOURCES: {
                        "toggle": ("4.138.85", "_attr_is_on"),
                    },
                }
            },
            {
                "switch": {
                    MK_INIT_PARAMS: {
                        MK_HASS_NAME: "doorbell_notification",
                    },
                    MK_RESOURCES: {
                        "toggle": ("4.154.85", "_attr_is_on"),
                    },
                }
            },
            {
                "switch": {
                    MK_INIT_PARAMS: {
                        MK_HASS_NAME: "face_recording",
                    },
                    MK_RESOURCES: {
                        "toggle": ("4.54.85", "_attr_is_on"),
                    },
                }
            },
            {
                "switch": {
                    MK_INIT_PARAMS: {
                        MK_HASS_NAME: "face_notification",
                    },
                    MK_RESOURCES: {
                        "toggle": ("4.55.85", "_attr_is_on"),
                    },
                }
            },
            {
                "number": {
                    MK_INIT_PARAMS: {
                        MK_HASS_NAME: "camera_volume",
                        "min_value": 0,
                        "max_value": 100,
                        "step": 1,
                    },
                    MK_RESOURCES: {"volume": ("14.65.85", "_attr_native_value")},
                }
            },
            {
                "number": {
                    MK_INIT_PARAMS: {
                        MK_HASS_NAME: "face_recognition_interval",
                        "min_value": 0,
                        "max_value": 65535,
                        "step": 1,
                        "unit_of_measurement": "s",
                    },
                    MK_RESOURCES: {"interval": ("14.110.85", "_attr_native_value")},
                }
            },
            {
                "select": {
                    MK_INIT_PARAMS: {
                        MK_HASS_NAME: "image_flip",
                        "options": ["normal", "horizontal", "vertical", "both"],
                    },
                    MK_RESOURCES: {
                        "value": ("14.68.85", "_attr_current_option"),
                    },
                }
            },
            {
                "event": {
                    MK_INIT_PARAMS: {
                        MK_HASS_NAME: "doorbell_ring",
                        "event_types": ["1"],
                        "entity_name": "门铃响铃",
                    },
                    MK_RESOURCES: {
                        "event": ("13.12.85", "_attr_trigger"),
                    },
                }
            },
            {
                "event": {
                    MK_INIT_PARAMS: {
                        MK_HASS_NAME: "face_detection",
                        "entity_name": "人脸识别",
                    },
                    MK_RESOURCES: {
                        "event": ("13.95.85", "_attr_trigger"),
                    },
                }
            },
            {
                "event": {
                    MK_INIT_PARAMS: {
                        MK_HASS_NAME: "stranger_detection",
                        "entity_name": "陌生人检测",
                    },
                    MK_RESOURCES: {
                        "event": ("13.108.85", "_attr_trigger"),
                    },
                }
            },
            {
    ...
    },
    {
        ...
        "params": [
            ...
            },
            {
                "switch": {
                    MK_INIT_PARAMS: {
                        MK_HASS_NAME: "wireless_mode",
                        "entity_category": "config",
                    },
                    MK_RESOURCES: {
                        "wireless_mode": ("8.0.2032", "_attr_is_on"),
                    },
                }
            },
            {
                "switch": {
                    MK_INIT_PARAMS: {
                        MK_HASS_NAME: "overload_protection",
                        "entity_category": "config",
                    },
                    MK_RESOURCES: {
                        "overload_protection": ("4.9.85", "_attr_is_on"),
                    },
                }
            },
            {
                "switch": {
                    MK_INIT_PARAMS: {
                        MK_HASS_NAME: "power_off_memory",
                        "entity_category": "config",
                    },
                    MK_RESOURCES: {
                        "power_off_memory": ("4.10.85", "_attr_is_on"),
                    },
                }
            },
        ],
    ...
    ###双键
    {
        ...
        "params": [
            ...
            },
            {
                "event": {
                    MK_INIT_PARAMS: {
                        MK_HASS_NAME: "left_button",
                        "event_types": ["click", "double_click"],
                        "entity_name": "左键按键",
                    },
                    MK_RESOURCES: {
                        "event": ("13.1.85", "_attr_trigger"),
                    },
                }
            },
            {
                "event": {
                    MK_INIT_PARAMS: {
                        MK_HASS_NAME: "right_button",
                        "event_types": ["click", "double_click"],
                        "entity_name": "右键按键",
                    },
                    MK_RESOURCES: {
                        "event": ("13.2.85", "_attr_trigger"),
                    },
                }
            },
            {
                "event": {
                    MK_INIT_PARAMS: {
                        MK_HASS_NAME: "both_buttons",
                        "event_types": ["click"],
                        "entity_name": "双键按键",
                    },
                    MK_RESOURCES: {
                        "event": ("13.5.85", "_attr_trigger"),
                    },
                }
            },
            {
                "switch": {
                    MK_INIT_PARAMS: {
                        MK_HASS_NAME: "left_button_physical_control",
                    },
                    MK_RESOURCES: {
                        "toggle": ("4.10.85", "_attr_is_on"),
                    },
                }
            },
            {
                "switch": {
                    MK_INIT_PARAMS: {
                        MK_HASS_NAME: "right_button_physical_control",
                    },
                    MK_RESOURCES: {
                        "toggle": ("4.11.85", "_attr_is_on"),
                    },
                }
            },
            {
                "switch": {
                    MK_INIT_PARAMS: {
                        MK_HASS_NAME: "indicator_light",
                    },
                    MK_RESOURCES: {
                        "toggle": ("8.0.2032", "_attr_is_on"),
                    },
                }
            },
            {
            ...
            },
            {
                "sensor": {
                    MK_INIT_PARAMS: {
                        MK_HASS_NAME: "device_protection",
                        "entity_category": "diagnostic",
                    },
                    MK_RESOURCES: {
                        "status": ("8.0.2014", "_attr_native_value"),
                    },
                }
            },
            {
                "button": {
                    MK_INIT_PARAMS: {
                        MK_HASS_NAME: "identify_device",
                    },
                    MK_RESOURCES: {
                        "press": ("8.0.2041", "_attr_pressed"),
                    },
                }
            },
        ],
    ...
    ###三键
    {
        ...
        "params": [
            ...
            },
            {
                "binary_sensor": {
                    MK_INIT_PARAMS: {
                        MK_HASS_NAME: "load_status",
                        "device_class": BinarySensorDeviceClass.PLUG,
                    },
                    MK_RESOURCES: {
                        "status": ("13.{}.85", "_attr_is_on"),
                    },
                    MK_MAPPING_PARAMS: {"ch_count": 3},
                }
            },
    ...
    {
        # 智能墙壁开关 acn034（零火线三键版带屏）
        "lumi.switch.acn034": ["Aqara", "Wall Switch acn034 (Three Rocker with Screen)", ""],
        "params": [
            {
                "switch": {
                    MK_INIT_PARAMS: {
            ...
            },
            {
                "number": {
                    MK_INIT_PARAMS: {
                        MK_HASS_NAME: "backlight_brightness",
                        "min_value": 1,
                        "max_value": 100,
                        "step": 1,
                    },
                    MK_RESOURCES: {"value": ("1.7.85", "_attr_native_value")},
                }
            },
            {
                "number": {
                    MK_INIT_PARAMS: {
                        MK_HASS_NAME: "standby_brightness",
                        "min_value": 0,
                        "max_value": 100,
                        "step": 1,
                    },
                    MK_RESOURCES: {"value": ("1.10.85", "_attr_native_value")},
                }
            },
            {
                "switch": {
                    MK_INIT_PARAMS: {
                        MK_HASS_NAME: "screensaver",
                    },
                    MK_RESOURCES: {
                        "toggle": ("4.46.85", "_attr_is_on"),
                    },
                }
            },
            {
                "switch": {
                    MK_INIT_PARAMS: {
                        MK_HASS_NAME: "key_sound",
                    },
                    MK_RESOURCES: {
                        "toggle": ("4.31.85", "_attr_is_on"),
                    },
                }
            },
            {
            ...
            },
            {
                "switch": {
                    MK_INIT_PARAMS: {
                        MK_HASS_NAME: "auto_brightness",
                    },
                    MK_RESOURCES: {
                        "toggle": ("4.14.85", "_attr_is_on"),
                    },
                }
            },
            {
                "number": {
                    ...
                    MK_RESOURCES: {"value": ("14.1.1000", "_attr_native_value")},
                }
            },
            {
                "binary_sensor": {
                    MK_INIT_PARAMS: {
                        MK_HASS_NAME: "alarm_status",
                        "device_class": BinarySensorDeviceClass.PROBLEM,
                    },
                    MK_RESOURCES: {
                        "status": ("14.1.111", "_attr_is_on"),
                    },
                }
            },
        ],
    ...
    {
        # 妙控开关 V1（零火线三键版）
        "lumi.switch.acn051": ["Aqara", "Wall Switch V1 (Three Rocker)", ""],
        "params": [
            {
                "switch": {
                    MK_INIT_PARAMS: {
            ...
            },
            {
                "number": {
                    ...
                    MK_RESOURCES: {"value": ("1.1.85", "_attr_native_value")},
                }
            },
            {
                "select": {
                    MK_INIT_PARAMS: {
                        MK_HASS_NAME: "power_on_state",
                        "options": ["memory", "on", "off", "inverse"],
                    },
                    MK_RESOURCES: {
                        "value": ("8.0.2259", "_attr_current_option"),
                    },
                }
            },
            {
    ...
    {
        # 场景面板（零火线四键版）
        "lumi.switch.n4acn4": ["Aqara", "Scene Panel (Four Rocker)", ""],
        "params": [
            {
                "switch": {
                    MK_INIT_PARAMS: {
            ...
            },
            {
                "switch": {
                    MK_INIT_PARAMS: {
                        MK_HASS_NAME: "physical_control_ch0",
                        "entity_category": "config",
                    },
                    MK_RESOURCES: {
                        "toggle": ("4.10.85", "_attr_is_on"),
            ...
            },
            {
                "switch": {
                    MK_INIT_PARAMS: {
                        MK_HASS_NAME: "physical_control_ch1",
                        "entity_category": "config",
                    },
                    MK_RESOURCES: {
                        "toggle": ("4.11.85", "_attr_is_on"),
            ...
            },
            {
                "switch": {
                    MK_INIT_PARAMS: {
                        MK_HASS_NAME: "physical_control_ch2",
                        "entity_category": "config",
                    },
                    MK_RESOURCES: {
                        "toggle": ("4.12.85", "_attr_is_on"),
                    },
                }
            },
            {
    ...
    ##########################通断器、插座开关#######################################
    {
        ...
        # 单路开关
        "lumi.switch.n0agl1": ["Aqara", "Single Switch", ""],
        # 智能插座 (国标)
    ...
    # 色温类
    {
        ...
        "params": [
            ...
            },
            {
                "number": {
                    MK_INIT_PARAMS: {
                        MK_HASS_NAME: "dimming_duration",
                        "min_value": 0,
                        "max_value": 255,
                        "step": 1,
                        "unit_of_measurement": "×100ms",
                    },
                    MK_RESOURCES: {"duration": ("8.0.2105", "_attr_native_value")},
                }
            },
            {
                "button": {
    ...
    },
    {
        ...
        "lumi.dimmer.acn003": ["Aqara", "智能灯带驱动器 T1 (60W)", "ZNDDQDQ11LM"],
        "lumi.dimmer.acn004": ["Aqara", "智能灯带驱动器 T1 (120W)", "ZNDDQDQ12LM"],
        "lumi.dimmer.acn005": ["Aqara", "智能灯带驱动器 T1 (240W)", "ZNDDQDQ13LM"],
        "params": [
            {
                "light": {
                    MK_INIT_PARAMS: {
            ...
            },
            {
                "number": {
                    MK_INIT_PARAMS: {
                        MK_HASS_NAME: "brightness_without_onoff",
                        "min_value": 0,
                        "max_value": 100,
                        "step": 1,
                        "unit_of_measurement": "%",
                    },
                    MK_RESOURCES: {"brightness": ("1.7.601", "_attr_native_value")},
                }
            },
        ],
    },
    {
        # Aqara 格栅灯
        "lumi.light.acn006": ["Aqara", "Smart Grille Light", ""],
        "params": [
            {
                "light": {
                    MK_INIT_PARAMS: {
        ...
        "params": [
            ...
            },
            {
                "light": {
                    ...
                    MK_RESOURCES: {
                        "toggle": ("4.2.85", "_attr_is_on"),
                        "brightness": ("14.12.85", "_attr_brightness"),
                        "color": ("14.21.85", "_attr_xy_color"),
                        "color_temp_kelvin": ("14.16.85", "_attr_color_temp_kelvin"),
                    },
                }
            },
            {
                "light": {
                    ...
                    MK_RESOURCES: {
                        "toggle": ("4.3.85", "_attr_is_on"),
                        "brightness": ("14.19.85", "_attr_brightness"),
                        "color": ("14.22.85", "_attr_xy_color"),
                        "color_temp_kelvin": ("14.17.85", "_attr_color_temp_kelvin"),
                    },
                }
            },
            {
                "light": {
                    ...
                    MK_RESOURCES: {
                        "toggle": ("4.4.85", "_attr_is_on"),
                        "brightness": ("14.20.85", "_attr_brightness"),
                        "color": ("14.23.85", "_attr_xy_color"),
                        "color_temp_kelvin": ("14.18.85", "_attr_color_temp_kelvin"),
                    },
                }
            },
            {
            ...
            },
            {
                "number": {
                    MK_INIT_PARAMS: {
                        MK_HASS_NAME: "channel_1_on_duration",
                        "min_value": 0,
                        "max_value": 65535,
                        "step": 1,
                        "unit_of_measurement": "×100ms",
                    },
                    MK_RESOURCES: {"duration": ("1.11.85", "_attr_native_value")},
                }
            },
            {
                "number": {
                    MK_INIT_PARAMS: {
                        MK_HASS_NAME: "channel_1_off_duration",
                        "min_value": 0,
                        "max_value": 65535,
                        "step": 1,
                        "unit_of_measurement": "×100ms",
                    },
                    MK_RESOURCES: {"duration": ("1.12.85", "_attr_native_value")},
                }
            },
            {
                "number": {
                    MK_INIT_PARAMS: {
                        MK_HASS_NAME: "channel_2_on_duration",
                        "min_value": 0,
                        "max_value": 65535,
                        "step": 1,
                        "unit_of_measurement": "×100ms",
                    },
                    MK_RESOURCES: {"duration": ("1.13.85", "_attr_native_value")},
                }
            },
            {
                "number": {
                    MK_INIT_PARAMS: {
                        MK_HASS_NAME: "channel_2_off_duration",
                        "min_value": 0,
                        "max_value": 65535,
                        "step": 1,
                        "unit_of_measurement": "×100ms",
                    },
                    MK_RESOURCES: {"duration": ("1.14.85", "_attr_native_value")},
                }
            },
            {
                "switch": {
    ...
    {
        # 魔方控制器 T1 Pro
        "lumi.remote.cagl02": ["Aqara", "Cube T1 Pro", "CTP-R01"],
        "params": [
            {
                "event": {
                    MK_INIT_PARAMS: {
                        MK_HASS_NAME: "cube_action",
                        "event_types_mapping": CUBE_ACTION_MAPPING,
                        "entity_name": "魔方动作",
                    },
                    MK_RESOURCES: {"action": ("13.1.85", "_attr_trigger")},
                }
            },
            {
                "sensor": {
                    MK_INIT_PARAMS: {
                        MK_HASS_NAME: "rotate_side",
                        "entity_name": "动作面",
                    },
                    MK_RESOURCES: {"side": ("13.101.85", "_attr_native_value")},
                }
            },
            {
                "sensor": {
                    MK_INIT_PARAMS: {
                        MK_HASS_NAME: "current_side",
                        "entity_name": "当前朝上面",
                    },
                    MK_RESOURCES: {"side": ("13.103.85", "_attr_native_value")},
                }
            },
            {
                "select": {
                    MK_INIT_PARAMS: {
                        MK_HASS_NAME: "device_mode",
                        "options": ["动作模式", "场景模式"],
                        "entity_name": "设备模式",
                    },
                    MK_RESOURCES: {
                        "value": ("14.35.85", "_attr_current_option"),
                    },
                }
            },
            {
                "sensor": {
                    MK_INIT_PARAMS: {
                        MK_HASS_NAME: "battery_voltage",
                        "device_class": SensorDeviceClass.VOLTAGE,
                        "state_class": SensorStateClass.MEASUREMENT,
                        "unit_of_measurement": "mV",
                        "entity_category": "diagnostic",
                    },
                    MK_RESOURCES: {"voltage": ("8.0.2008", "_attr_native_value")},
                }
            },
            {
                "binary_sensor": {
                    MK_INIT_PARAMS: {
                        MK_HASS_NAME: "battery_low",
                        "device_class": BinarySensorDeviceClass.BATTERY,
                        "entity_category": "diagnostic",
                    },
                    MK_RESOURCES: {"status": ("8.0.9001", "_attr_is_on")},
                }
            },
            {
                "sensor": {
                    MK_INIT_PARAMS: {
                        MK_HASS_NAME: "zigbee_lqi",
                        "entity_category": "diagnostic",
                    },
                    MK_RESOURCES: {"lqi": ("8.0.2007", "_attr_native_value")},
                }
            },
            {
                "button": {
    ...
    },
    {
        ...
        "params": [
            ...
            },
            {
                "sensor": {
                    MK_INIT_PARAMS: {
                        MK_HASS_NAME: "people_count",
                        "state_class": SensorStateClass.MEASUREMENT,
                        "entity_name": "People Count",
                    },
                    MK_RESOURCES: {"count": ("13.120.85", "_attr_native_value")},
                    MK_MAPPING_PARAMS: {"ch_count": None},
                }
            },
            {
                "sensor": {
                    MK_INIT_PARAMS: {
                        MK_HASS_NAME: "people_count_per_min",
                        "state_class": SensorStateClass.MEASUREMENT,
                        "entity_name": "People Count Per Minute",
                    },
                    MK_RESOURCES: {"count": ("0.61.85", "_attr_native_value")},
                    MK_MAPPING_PARAMS: {"ch_count": None},
                }
            },
            {
                "select": {
                    MK_INIT_PARAMS: {
                        MK_HASS_NAME: "work_mode",
                        "options": ["presence", "positioning", "fall_detection", "sleep", "gesture"],
                        "entity_name": "Work Mode",
                    },
                    MK_RESOURCES: {
                        "value": ("14.49.85", "_attr_current_option"),
                    },
                    MK_MAPPING_PARAMS: {"ch_count": None},
                }
            },
            {
                "binary_sensor": {
                    MK_INIT_PARAMS: {
                        MK_HASS_NAME: "fall_detection",
                        "device_class": BinarySensorDeviceClass.SAFETY,
                        "entity_name": "Fall Detection",
                    },
                    MK_RESOURCES: {
                        "status": ("14.50.85", "_attr_is_on"),
                    },
                    MK_MAPPING_PARAMS: {"ch_count": None},
                }
            },
            {
                "binary_sensor": {
                    MK_INIT_PARAMS: {
                        MK_HASS_NAME: "sleep_status",
                        "entity_name": "Sleep Status",
                    },
                    MK_RESOURCES: {
                        "status": ("14.51.85", "_attr_is_on"),
                    },
                    MK_MAPPING_PARAMS: {"ch_count": None},
                }
            },
            {
                "select": {
                    MK_INIT_PARAMS: {
                        MK_HASS_NAME: "detection_mode",
                        "options": ["non_directional", "left_right"],
                        "entity_name": "Detection Mode",
                    },
                    MK_RESOURCES: {
                        "value": ("14.55.85", "_attr_current_option"),
                    },
                    MK_MAPPING_PARAMS: {"ch_count": None},
                }
            },
            {
                "number": {
                    MK_INIT_PARAMS: {
                        MK_HASS_NAME: "detection_sensitivity",
                        "min_value": 1,
                        "max_value": 10,
                        "step": 1,
                        "entity_name": "Detection Sensitivity",
                    },
                    MK_RESOURCES: {"value": ("14.52.85", "_attr_native_value")},
                    MK_MAPPING_PARAMS: {"ch_count": None},
                }
            },
            {
                "number": {
                    MK_INIT_PARAMS: {
                        MK_HASS_NAME: "detection_distance",
                        "min_value": 0,
                        "max_value": 10,
                        "step": 0.1,
                        "entity_name": "Detection Distance",
                    },
                    MK_RESOURCES: {"value": ("14.53.85", "_attr_native_value")},
                    MK_MAPPING_PARAMS: {"ch_count": None},
                }
            },
        ],
    ...
    {
        # 智能电热毛巾架
        "aqara.tow_w.acn001": ["Aqara", "Smart Towel Warmer", ""],
        "params": [
            {
                "switch": {
                    MK_INIT_PARAMS: {
            ...
            },
            {
                "number": {
                    ...
                    MK_RESOURCES: {"temperature": ("14.92.85", "_attr_native_value")},
                }
            },
            {
                "number": {
                    MK_INIT_PARAMS: {
                        MK_HASS_NAME: "drying_duration",
                        "min_value": 30,
                        "max_value": 480,
                        "step": 1,
                        "unit_of_measurement": "min",
                    },
                    MK_RESOURCES: {"duration": ("14.93.85", "_attr_native_value")},
                }
            },
            {
                "sensor": {
            ...
            },
            {
                "sensor": {
                    MK_INIT_PARAMS: {
                        MK_HASS_NAME: "fault_status",
                        "device_class": "",
                    },
                    MK_RESOURCES: {"status": ("13.11.85", "_attr_native_value")},
                }
            },
        ],
    },
